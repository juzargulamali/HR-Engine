 ...
 * renders and that "manage" controls are correctly scoped to HR Admin.
 */
test.describe("holidays", () => {
  ...
  test("'Add a holiday' is offered to HR Admin but not to a plain employee", async ({ employeePage, hrAdminPage }) => {
